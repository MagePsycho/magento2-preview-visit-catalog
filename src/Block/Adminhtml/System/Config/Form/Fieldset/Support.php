...
namespace MagePsycho\GoToCatalog\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_GoToCatalog::system/config/form/fieldset/support.phtml';
