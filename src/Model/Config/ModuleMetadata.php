...
namespace MagePsycho\GoToCatalog\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME  = 'Go To Catalog';

    const PRODUCT_URL = 'https://www.magepsycho.com/magento2-go-to-catalog.html';

    const MODULE_NAME = 'MagePsycho_GoToCatalog';

    const VERSION_CACHE_KEY = 'mp-gtc-module-version';
